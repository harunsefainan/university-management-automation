<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ogrenci_listesi.aspx.cs" Inherits="Okul.ogrenci.ogrenci_listesi" %>
...
<body>
    ...
    <tbody>
        <asp:Repeater ID="FakulteList" runat="server">
            ...
            <tr>
                ...
                <td><asp:HyperLink  NavigateUrl='<%#"ogrenci_sil.aspx?id="+Eval("ID") %>' runat="server" CssClass="btn btn-danger" >Sil</asp:HyperLink> 
                <asp:HyperLink NavigateUrl='<%#"ogrenci_duzenle.aspx?id="+Eval("ID") %>' runat="server" CssClass="btn btn-primary">Düzenle</asp:HyperLink>
                </td>
    ...
    <a href="/ogrenci/ogrenci_ekle.aspx/" button class="btn btn-success" style="margin-top:10px;">Öğrenci Ekle</a>
</div>
    </div>
<br />
    <br />
