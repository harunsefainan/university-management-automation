<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fakulte_ekle.aspx.cs" Inherits="Okul.fakulte.fakulte_ekle" %>
    ...
    <div class="container">
       <form id="form1" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtFakulteAdi" runat="server" ErrorMessage="Fakülte Adı gerekli"></asp:RequiredFieldValidator>
        </div>
