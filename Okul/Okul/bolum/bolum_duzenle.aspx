<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bolum_duzenle.aspx.cs" Inherits="Okul.bolum.bolum_guncelle" %>
    ...
    <div class="container">
       <form id="form1" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:TextBox runat="server" ID="txtBolumAdi" CssClass="form-control"/>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtBolumAdi" runat="server" ErrorMessage="Bölüm Adı gerekli"></asp:RequiredFieldValidator>
        </div>          
           <asp:Button Text="Kaydet" ID="btnDuzenle" runat="server"  cssClass="btn btn-success"  OnClick ="btnDuzenle_Click"/>
           <a  class="btn btn-danger" href ="/bolum/bolum_listesi.aspx">İptal</a>
       </form>
    </div>
    <br />
    <br />
