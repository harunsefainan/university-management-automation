<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bolum_listesi.aspx.cs" Inherits="Okul.bolum.bolum_listesi" %>
...
<body>
    ...
    <tbody>
        <asp:Repeater ID="FakulteList" runat="server">
            ...
            <tr>
                ...
                <td><asp:HyperLink  NavigateUrl='<%#"bolum_sil.aspx?id="+Eval("ID") %>' runat="server" CssClass="btn btn-danger" >Sil</asp:HyperLink> 
                    <asp:HyperLink NavigateUrl='<%#"bolum_duzenle.aspx?id="+Eval("ID") %>' runat="server" CssClass="btn btn-primary">Düzenle</asp:HyperLink></td> 
            </tr>
            </ItemTemplate>
        </asp:Repeater>       
    </tbody>
    ...
    <a href="/bolum/bolum_ekle.aspx/" button class="btn btn-success" style="margin-top:10px;">Bölüm Ekle</a>
</div>
    </div>
    <br />
    <br />
